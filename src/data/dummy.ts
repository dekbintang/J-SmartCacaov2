...
export const tourismSpots: TourismSpot[] = [
  ...
  {
    id: 'tour-12',
    name: 'Workshop Cokelat',
    category: 'agro',
    location: 'Br. Pangkung buluh-Kaliakah, Negara, Jembrana, Bali 82218',
    village: 'Kaliakah',
    lat: -8.3500, lng: 114.6200,
    description: 'Buat cokelatmu sendiri bersama pengrajin artisan kami. Dari biji hingga batang cokelat, semua di tanganmu.',
    ...
    closedDay: '-',
    facilities: ['Tutor Artisan', 'Apron & Topi Chef', 'Sertifikat', 'Bawa Pulang Cokelat'],
    tags: ['Workshop', 'Fresh Chocolate Making', 'Edukasi'],
    isFeatured: false,
