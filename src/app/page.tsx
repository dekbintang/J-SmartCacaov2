...
const FEATURES = [
  ...
  { icon: BookOpen, color: 'emerald', titleId: 'Edu-Tourism', titleEn: 'Edu-Tourism', en: 'Interactive Education', descId: 'Menyelami kisah di balik setiap gigitan cokelat. Temukan kearifan lokal Subak Abian, dedikasi para petani, hingga keajaiban proses fermentasi melalui pengalaman digital yang imersif.', descEn: 'Dive into the story behind every bite. Discover the ancient wisdom of Subak Abian, the dedication of local farmers, and the magic of fermentation through an immersive digital journey.', href: '/edukasi', ctaId: 'Jelajahi Edukasi', ctaEn: 'Explore Education' },
